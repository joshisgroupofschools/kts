...
export function computeSystemAnalytics(
  ...
  students.forEach((student) => {
    ...
    if (student.isActive) {
      ...
      // Inactive students contribute to historical collected revenue
      totalCollectedTillDate += fin.totalPaid;
    }
  });

  // Calculate All-Time Valid Collections Breakdown (Cash vs UPI)
  ...
  installments.forEach((inst) => {
    ...
    stat.totalCollected += inst.paidAmount;
